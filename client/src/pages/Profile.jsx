        ...
        {userListings.map((listing) => (
          <div key={listing._id} className="border rounded-lg p-3 flex justify-between items-center gap-4">
            ...
            <div className="flex flex-col items-center">
              <button onClick={()=>handleListingDelete(listing._id)} className="bg-red-700 text-white text-sm uppercase hover:opacity-80 p-2 border rounded-md">Delete</button>
              <Link to={`/update-listing/${listing._id}`}>
                <button className="bg-green-700 text-white text-sm uppercase hover:opacity-80 p-2 border rounded-md">Edit</button>
              </Link>
            </div>
          </div>
        ))}
